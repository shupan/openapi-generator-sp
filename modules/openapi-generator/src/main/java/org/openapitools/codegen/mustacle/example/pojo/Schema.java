...
public class Schema{
	...
	@JSONField(name="containerTypeMapped")
	private String containerTypeMapped;

	@JSONField(name="mostInnerItems")
	private MostInnerItems mostInnerItems;
	...
	public void setMostInnerItems(MostInnerItems mostInnerItems){
		this.mostInnerItems = mostInnerItems;
	}

	public MostInnerItems getMostInnerItems(){
